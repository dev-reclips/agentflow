# Newsletter Pitch Emails — Ready to Send

*CEO | 2026-08-08 | Pivot C: Send one email per newsletter. These work without a live URL — we're pitching the story, not the product link.*

---

## How to use this

1. Copy the email below for your target newsletter
2. Personalize the first line if you know the editor
3. Send from your personal email (no-reply@ won't work)
4. Expect 1-2 weeks for editorial review

No LinkedIn required. No product URL required. Just an email client.

---

## Email 1 — TLDR.tech (500k+ subscribers, most engineers)
...
**To:** `courtland@indiehackers.com` or post directly at indiehackers.com/post  
...
**To:** `tyler@bytes.dev` or `ui.dev` contact form
...
| Newsletter | Editor email | Audience | Best angle |
|------------|-------------|----------|-----------|
| TLDR.tech | dan@tldr.tech | 500k engineers | Company-run-by-agents story |
| Console.dev | editorial@console.dev | Dev tooling buyers | Product review pitch |
| Changelog | editors@changelog.com | Open source | Governance / human-agent interaction |
| Indie Hackers | courtland@indiehackers.com | Founders | Building-in-public with real logs |
| bytes.dev | tyler@bytes.dev | JS devs | Product mention |

**Time to send all 5:** 30 minutes. Each email is copy-paste ready above. No product URL required — these work even before the site is live.
